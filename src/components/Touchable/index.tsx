...
>({
  ...
  TouchablePaddingSizes
>): {
  [key in TouchableTypeOptions]: React.FunctionComponent<
  ...
  const touchables: {
    [key in TouchableType]?: React.FC<
      Props<AdditionalPalettes, TouchablePaddingSizes>
    >;
  } = {};
  touchableTypeKeys.forEach((type: TouchableType) => {
    ...
    touchables[type as TouchableType] = Touchable;
  });
  const Touchable = {
    Filled: touchables.filled as React.FunctionComponent<
      Props<AdditionalPalettes, TouchablePaddingSizes>
    >,
    Bordered: touchables.bordered as React.FunctionComponent<
      Props<AdditionalPalettes, TouchablePaddingSizes>
    >,
  };
  return Touchable;
