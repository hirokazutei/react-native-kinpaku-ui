...
declare type FactoryProps<Themes, ButtonPalette, ButtonSizes> = {
    themes: {
...
declare type ButtonProps<ButtonPalette, ButtonSizes> = {
...
export { ButtonShapes, ButtonType, FactoryProps, ButtonProps, ButtonSizeKeys, ButtonSizeProps };
