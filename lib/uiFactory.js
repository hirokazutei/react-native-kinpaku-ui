...
export default function UIFactory(themes, additionalPalettes) {
    ...
    const RadioButton = radioButtonFactory(Object.assign({}, commonProps, { sizes: DEFAULT_RADIO_BUTTON_SIZES }));
    const Touchable = touchableFactory(Object.assign({}, commonProps, { sizes: DEFAULT_TOUCHABLE_SIZES }));
    const { Title, Heading, SubHeading, Body, Caption, Quote } = textFactory(Object.assign({}, commonProps, { defaultFontSizeKey: 'medium', textVariations: DEFAULT_TEXT_VARIATIONS }));
    return {
        Button,
        RadioButton,
        Touchable,
