...
const DEFAULT_INPUT_VARIATION_SETTING = {
  ...
  oneTimeNumberCode: Object.assign(
    {
      autoCapitalize: 'none',
      autoCorrect: false,
      caretHidden: true,
...
const INPUT_FIELD_TYPE = ['underline', 'outline', 'fill'];
export {
