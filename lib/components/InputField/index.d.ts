...
declare function inputFieldFactory<Themes, AdditionalPalettes, InputFieldSize, AllowCustomProps>({ themes, additionalPalettes, sizes, defaultColor, inputFieldType, defaultShape, }: InputFieldFactoryProps<Themes, AdditionalPalettes, InputFieldSize, AllowCustomProps>): {
