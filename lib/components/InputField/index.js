    ...
    for (const settingKey in DEFAULT_INPUT_VARIATION_SETTING) {
        if (DEFAULT_INPUT_VARIATION_SETTING.hasOwnProperty(settingKey)) {
            const InputField = (_a) => {
                ...
                const declaredTextColor = (textColor !== null && textColor !== void 0 ? textColor : isFill) ? 'background' : color;
                const primaryBackgroundColor = colorResolver({
                    color: backgroundColor !== null && backgroundColor !== void 0 ? backgroundColor : color,
                ...
                // WrappedStyle
                const wrapperStyleProps = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ flexDirection: 'row' }, (isDisabled ? { borderColor: disabledColor } : borderColorProp)), (isDisabled
