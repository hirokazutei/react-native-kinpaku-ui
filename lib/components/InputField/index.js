        ...
        if (DEFAULT_INPUT_VARIATION_SETTING.hasOwnProperty(settingKey)) {
            const InputField = (_a) => {
                ...
                const leftItemViewStyle = {
                    style: Object.assign({}, (sizeProp.leftItemSpacing ? sizeProp.leftItemSpacing : {})),
                };
                // RightItemViewStyle
                const rightItemViewStyle = {
                    style: Object.assign({}, (sizeProp.rightItemSpacing ? sizeProp.rightItemSpacing : {})),
                };
                return (<View style={wrapperStyleProps} {...(_customWrapperProps ? _customWrapperProps : {})}>
            {!!(leftItem || staticLeftItem) && (<View {...leftItemViewStyle}>{leftItem || staticLeftItem}</View>)}
            ...
            {!!(rightItem || staticRightItem) && (<View {...rightItemViewStyle}>
