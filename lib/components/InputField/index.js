...
import { CIRCULAR, DEFAULT_INPUT_FIELD_BORDER_WIDTH, DEFAULT_INPUT_FIELD_SIZE, DEFAULT_INPUT_VARIATION_SETTING, ROUND, OUTLINE, UNDERLINE, FILL, } from './constants';
function inputFieldFactory({ themes, additionalPalettes, sizes, shape = ROUND, defaultColor, defaultType = OUTLINE, }) {
    // Context
    ...
    for (const settingKey in DEFAULT_INPUT_VARIATION_SETTING) {
        if (DEFAULT_INPUT_VARIATION_SETTING.hasOwnProperty(settingKey)) {
            const InputField = (_a) => {
                ...
                // WrappedStyle
                const wrapperStyleProps = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ alignItems: 'center', flexDirection: 'row' }, (isDisabled ? { borderColor: disabledColor } : borderColorProp)), (isDisabled
                    ? { backgroundColor: disabledBackground }
                    : backgroundColorProp)), borderWidthProp), borderBottomWidthProp), borderRadiusProp), (sizeProp.fieldSpacing ? sizeProp.fieldSpacing : {})), (_customWrapperStyle ? _customWrapperStyle : {}));
                // FieldStyle
                const fieldStyleProps = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ flex: 1 }, (sizeProp.textSpacing ? sizeProp.textSpacing : {})), (isBold ? { fontWeight: 'bold' } : {})), (isItalic ? { fontStyle: 'italic' } : {})), (fontFamily ? { fontFamily } : {})), (isDisabled ? { color: disabledColor } : { color: primaryTextColor })), (textAlign ? { textAlign } : {})), { fontSize: sizeProp.fontSize }), (letterSpacing ? { letterSpacing } : {})), (lineHeight ? { lineHeight } : {})), (_customTextInputStyle ? _customTextInputStyle : {}));
                // LeftItemViewStyle
                const leftItemViewStyle = Object.assign({}, (sizeProp.leftItemSpacing ? sizeProp.leftItemSpacing : {}));
                // RightItemViewStyle
                const rightItemViewStyle = Object.assign({}, (sizeProp.rightItemSpacing ? sizeProp.rightItemSpacing : {}));
                return (<View style={wrapperStyleProps} {...(_customWrapperProps ? _customWrapperProps : {})}>
            {!!(leftItem || staticLeftItem) && (<View style={leftItemViewStyle}>
            ...
            {!!(rightItem || staticRightItem) && (<View style={rightItemViewStyle}>
