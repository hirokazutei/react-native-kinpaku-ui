...
declare type RadioButtonFactoryProps<Themes extends GenericTheme = DefaultTheme, AdditionalPalettes extends GenericAdditionalPalette | NonExistent = null, RadioButtonSize extends Record<string | string, RadioButtonSizeProps> | NonExistent = null, AllowCustomProps extends boolean | NonExistent = false> = {
...
declare type RadioButtonProps<AdditionalPalettes extends GenericAdditionalPalette | NonExistent = null, RadioButtonSize extends Record<string | string, RadioButtonSizeProps> | NonExistent = null, AllowCustomProps extends boolean | NonExistent = false> = {
