...
function touchableFactory({ themes, sizes, additionalPalettes, defaultType = 'solid', allowCustomProps, }) {
    ...
    const Touchable = ({ color = 'primary', size = 'default', children, isDisabled = false, isStretched, align = DEFAULT_TOUCHABLE_ALIGN, onPress, type = defaultType, additionalProps, additionalStyle, }) => {
        // Palettes
