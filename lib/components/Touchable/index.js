        ...
        const Touchable = ({ color, size = 'default', children, isDisabled = false, isStretched, align = DEFAULT_TOUCHABLE_ALIGN, onPress, _additionalProps, _additionalStyle, }) => {
            ...
            const touchablePaddingHorizontal = (touchablePaddingProperty &&
                touchablePaddingProperty
                    .paddingHorizontal) ||
                touchablePaddingProperty.padding;
            const touchableStyle = Object.assign({ alignSelf: !isStretched ? align : 'stretch', alignItems: 'center', borderRadius: borderRadius, backgroundColor: fillColor, paddingHorizontal: touchablePaddingHorizontal || DEFAULT_TOUCHABLE_SIZE.default.padding, paddingVertical: touchablePaddingVertical || DEFAULT_TOUCHABLE_SIZE.default.padding }, borderStyles, _additionalStyle);
