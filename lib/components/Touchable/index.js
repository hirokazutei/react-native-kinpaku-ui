...
function touchableFactory({ themes, sizes, additionalPalettes, }) {
    ...
    for (const typeKey of TOUCHABLE_TYPE_VARIATION_KEYS) {
        const Touchable = ({ color, size = 'default', children, isDisabled = false, isStretched, align = DEFAULT_TOUCHABLE_ALIGN, onPress, _customProps, _customStyle, }) => {
            // Palettes
            ...
            const fillColor = typeKey === 'Fill' ? primaryColor : currentTheme.background;
            // Size
            ...
            const touchablePaddingHorizontal = (touchablePaddingProperty &&
                touchablePaddingProperty
                    .paddingHorizontal) ||
                touchablePaddingProperty.padding;
            const touchableStyle = Object.assign(Object.assign({ alignSelf: !isStretched ? align : 'stretch', alignItems: 'center', borderRadius: borderRadius, backgroundColor: fillColor, paddingHorizontal: touchablePaddingHorizontal || DEFAULT_TOUCHABLE_SIZE.default.padding, paddingVertical: touchablePaddingVertical || DEFAULT_TOUCHABLE_SIZE.default.padding }, borderStyles), _customStyle);
