    ...
    for (const variationName in variation
        ...
        if ((variation
            ...
            const Text = ({ _customTextProps, _customTextStyle, align, color, children, ellipsizeMode, isBold, isItalic, isLinethrough, isUnderline, numberOfLines, size, }) => {
                ...
                // Text Props
                const textProps = Object.assign(Object.assign(Object.assign(Object.assign({ ellipsizeMode,
                    numberOfLines }, (allowFontScaling ? { allowFontScaling } : {})), (maxFontSizeMultiplier ? { maxFontSizeMultiplier } : {})), (minimumFontScale ? { minimumFontScale } : {})), _customTextProps);
