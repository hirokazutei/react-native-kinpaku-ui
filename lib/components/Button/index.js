...
function buttonFactory({ themes, sizes, additionalPalettes, defaultType = 'solid', }) {
    ...
    BUTTON_VARIATION_KEYS.forEach((variation) => {
        const Button = ({ color, size = 'default', isDisabled, isStretched, align = DEFAULT_BUTTON_ALIGN, onPress, title, type = defaultType, _additionalButtonProps, _additionalButtonStyle, _additionalTextProps, _additionalTextStyle, }) => {
            // Palettes
            ...
            const touchableStyle = Object.assign(Object.assign({ borderRadius: borderRadius, backgroundColor: buttonColor, paddingHorizontal: (buttonSizeProperty && buttonSizeProperty.horizontalPadding) ||
                    DEFAULT_BUTTON_SIZES.default.horizontalPadding, alignItems: align, alignSelf: !isStretched
